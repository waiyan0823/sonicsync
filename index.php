...
<section class="dashboard-hero">
    <div class="dashboard-hero-copy">
        ...
        <div class="dashboard-actions">
            <a class="btn" href="analysis.php">Start Analysis <span aria-hidden="true">→</span></a>
            <a class="btn secondary" href="analysis.php">Open Student List</a>
        </div>
...
<section class="dashboard-section workflow-section">
    ...
    <div class="dashboard-workflow">
        <article class="workflow-card">
            ...
            <a href="analysis.php">Open student list <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article class="workflow-card">
            ...
            <a href="analysis.php">Open analysis <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article class="workflow-card">
            ...
            <a href="analysis.php">Enter responses <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article class="workflow-card">
            ...
            <a href="result.php">View latest result <span aria-hidden="true">→</span></a>
        </article>
    </div>
</section>
...
<section class="dashboard-section input-story">
    <div class="input-story-copy">
        ...
        <a class="text-link" href="analysis.php">Begin with a student <span aria-hidden="true">→</span></a>
    </div>
...
<section class="dashboard-cta">
    ...
    <a class="btn" href="analysis.php">Start Personality Analysis <span aria-hidden="true">→</span></a>
</section>
